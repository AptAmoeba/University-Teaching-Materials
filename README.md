...
Malware will be moved to C:\Temp\Infected. Use a zipping tool to Zip + Password Protect this Folder. Transport the folder to a shared destination, like a temp site like temp.sh
...
Back in the Tasks window, we will *again* Right-Click that Task, and then hit "Export." Export the resulting XML file to C:\Temp\Infected. This is good evidence
...
- Computer\HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Schedule\TaskCache\Tasks
    - Searching for "{87C13C22-D9AA-4982-AC5A-247FA6EEF916}" 
